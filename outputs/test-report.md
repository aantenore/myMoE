...
- `tests/test_extensions.py`: registry loading, guided extension templates including storage-inspection presets, plugin-local skill discovery, plugin audit, and runtime plan coverage.
...
- compileall: passed
- unit/contract tests: `241/241` passed
