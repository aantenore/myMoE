...
- `tests/test_web.py`: web config, generation, persisted chat sessions, chat compaction APIs, memory APIs, chat management APIs, setup preparation APIs, plugin creation APIs, extension audit APIs, cron status APIs, and eval endpoints over a local HTTP server.
...
- compileall: passed
- unit/contract tests: `141/141` passed
