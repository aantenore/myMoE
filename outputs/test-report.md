...
- `tests/test_run_log.py`: metadata-only generation run writes, prompt/answer exclusion, latest-first listing, and latest-run retention pruning.
...
- compileall: passed
- unit/contract tests: `221/221` passed
