...
The test hardening pass added coverage for configuration validation, routing evaluation, OpenAI-compatible provider contracts, runtime server specs, CLI behavior, context assembly, file-backed memory, and orchestrator correlation behavior.
...
- compileall: passed
- unit/contract tests: `31/31` passed
