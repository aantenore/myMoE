...
The provenance-bound 2026-07-21 run used the pinned Qwen3 4B and 1.7B MLX
...
from `3.4607 s` to `3.3357 s`, and reached a median routed-pair latency ratio of
`0.4832`. Host sampling covered every observation, peak RAM use was `87.815%`,
and swap grew by `342,485,894` bytes. The release quality gate passed and marked
...
`3.9766 s`. These results are bounded to the committed eight-case rubric and
