.PHONY: check test eval distill-router prepare-runtime cron-status run-cron run-cron-writes ui cli doctor setup-models start-models benchmark-small benchmark-gemma
