...
Profiles lists runnable local model configs, active/default flags, setup readiness, backend, model names, and launch hints for setup, model startup, UI startup, and CLI usage without switching runtime state.
